...
<script src="../bootstrap/js/showhide.min.js"></script>
 <script>
    ...
    $(function() {
    $('#email,#password,#cpassword,#firstname').on('keypress', function(e) {
        if (e.which == 32)
            return false;
    });
});
          ...
          <div class="panel-body">
            ...
            <form class="form-horizontal" action="<?php echo base_url('Mainpage/signupAction'); ?>" method="post" id="loginForm">
              <fieldset class="fieldset" style="padding-top: 10px;">
                  ...
                  <div class="col-xs-4">
                    <input type="text" required maxlength="19" class="form-control" id="surname" name="surname" placeholder="Surname" autocomplete="off" pattern="[a-zA-Z]+"  title="This appears to your profile." />
                  </div>
                  <div class="col-xs-4">
                    <input type="text" required maxlength="19" class="form-control" id="firstname" name="firstname" placeholder="Firstname" autocomplete="off" pattern="[a-zA-Z]+" title="This appears to your profile." />
                  </div>
                </div>    
                ...
                <div class="form-group">
                  <div class="col-sm-offset-4 col-xs-10" style="padding-left: 22px; color: black; ">Already have an account?
