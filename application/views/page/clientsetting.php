  ...
  <div class="container" style="padding-top: 100px;">
		<div class="col-md-12">
			...
			<div class="col-md-4">
				...
				<p style="padding-left: 40px;">Name:<?php echo' '.$row['firstname'].' '.$row['surname'].'';?></p>
				<p style="padding-left: 40px;">Contact #:</p>
				<p style="padding-left: 40px;">Address:</p>
				<p style="padding-left: 40px;">Address:</p>
				</div>
				</div>
				...
				<p style="padding-left: 40px;">Email:<?php echo $row['email']; ?></p>
				</div>
				</div>
				<?php endforeach; ?>
