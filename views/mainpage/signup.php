            ...
            <form class="form-horizontal" action="<?php echo base_url('Mainpage/signupAction'); ?>" method="post" id="loginForm">
              <fieldset class="fieldset">
                ...
                <div class="form-group">
                  ...
                  <div class="col-xs-9">
                    <input type="password" required minlength="8" maxlength="30" class="form-control" id="password" name="password" placeholder="Password" autocomplete="off" pattern="(?=.*\d)[a-zA-Z0-9]+" title="Must contain at least one number and can be 8 (min) characters long" />
