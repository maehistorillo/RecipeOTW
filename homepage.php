...
<head>
	<script type="javascript" src="<?php echo base_url('bootstrap/js/star-rating.min.js');?>"></script>
	<style type="text/css">
        ...
        <div class="row"> 
			...
			<div class="team boxed-grey" style="white-space: normal; 
				...
				text-overflow: ellipsis; ">	
					  <img src="<?php echo base_url('bootstrap/img/cat/lambcurry.jpg'); ?>" alt="Kare Kare" style="width:100%; padding: 5px;">
					  <h5>Dish</h5>
					  <pre class="title" style="border: none; padding: 5px; margin: 0px;">Home-Style Lamb Curry</pre>
					  <div class="stars">
						  <form action="">
			...
			<div class="team boxed-grey" style="white-space: normal; 
				...
				overflow: hidden;
				text-overflow: ellipsis; ">	
					  <img src="<?php echo base_url('bootstrap/img/cat/parmesanpotatosalad.jpg'); ?>" alt="Spag" style="width:100%; padding: 5px;">
				  <h5>Side Dish</h5>
				  <pre class="title" style="border: none; padding: 5px; margin: 0px;">Lemon-Caper Parmesan Potato Salad Bite</pre>
					<div class="stars">
						  <form action="">
			...
			<div class="team boxed-grey" style="white-space: normal; 
				...
				overflow: hidden;
				text-overflow: ellipsis; ">
				  <img src="<?php echo base_url('bootstrap/img/cat/yogurtpistacio.jpg'); ?>" alt="Burger" style="width:100%; padding: 5px;">
				  <h5>Dessert</h5>
				  <pre class="title" style="border: none; padding: 5px; margin: 0px;">Easy Yogurt, Honey And Pistachio Popsicles</pre>
					<div class="stars">
						  <form action="">
			...
			<div class="team boxed-grey" style="white-space: normal; 
				...
				overflow: hidden;
				text-overflow: ellipsis; ">
				  <img src="<?php echo base_url('bootstrap/img/cat/Heavenly Blueberry Smoothie.jpg'); ?>"" alt="Pizza" style="width:100%; padding: 5px;">
				  <h5>Smoothies</h5>
				  <pre class="title" style="border: none; padding: 5px; margin: 0px;">Heavenly Blueberry Smoothie</pre>
					<div class="stars">
						  <form action="">
